...
//		 gl.glBlendFunc(GL10.GL_ONE, GL10.GL_SRC_COLOR);
	...
	private void setTransLation_Z (){
		if (stlObject != null) {
			Log.i("zwcmaxX:" + stlObject.maxX);
			Log.i("zwcminX:" + stlObject.minX);
			Log.i("zwcmaxY:" + stlObject.maxY);
			Log.i("zwcminY:" + stlObject.minY);
			Log.i("zwcmaxZ:" + stlObject.maxZ);
			Log.i("zwcminZ:" + stlObject.minZ);
		}
		//算x、y轴差值
